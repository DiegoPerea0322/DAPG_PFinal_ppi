  ...
  <div class="container pt-4">
    ...
    <section class="mb-4">
      <div class="card shadow-0 border">
        <div class="card-body">
        <h5 class="card-title mb-3">Selecciona Productos a Eliminar</h5>
                ...
                while($row = mysqli_fetch_array($result)) {
                    ...
                    echo "</div>
                            ...
                            <div class=\"col-xl-2 col-md-2 col-sm-2\">
                                <input type=\"checkbox\" name=\"selectedValues[]\" value=\"" .$row['id_producto']. "\"> Eliminar producto
                            </div>
        ...
        ?>
                ...
                <div class="float-end">
              	<button type="submit" class="btn btn-success shadow-0 border" name="delete">Eliminar productos seleccionados</button>
            	</div>            
        ...
        $con = mysqli_connect("localhost", "root", "dapg100318","p_final");
            ...
            if (mysqli_connect_errno()) {
                ...
                foreach ($selectedValues as $value) {
                    ...
                    $sql = "DELETE FROM producto WHERE id_producto = $valor ;";
